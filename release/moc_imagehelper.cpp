...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_ImageHelper_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_ImageHelper_t qt_meta_stringdata_ImageHelper = {
    {
QT_MOC_LITERAL(0, 11) // "ImageHelper"
...
const QMetaObject ImageHelper::staticMetaObject = { {
    ...
    qt_meta_stringdata_ImageHelper.offsetsAndSize,
    qt_meta_data_ImageHelper,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ImageHelper_t
, QtPrivate::TypeAndForceComplete<ImageHelper, std::true_type>
